 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-portal-system.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-portal-system.php</code></p>';
