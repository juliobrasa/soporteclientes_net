 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-unified-panel.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-unified-panel.php</code></p>';
