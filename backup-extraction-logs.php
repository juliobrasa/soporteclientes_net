 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/backup-extraction-logs.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/backup-extraction-logs.php</code></p>';
