 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-booking-extraction.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-booking-extraction.php</code></p>';
