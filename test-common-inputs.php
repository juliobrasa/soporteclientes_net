 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-common-inputs.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-common-inputs.php</code></p>';
