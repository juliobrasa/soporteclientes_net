 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-real-extraction.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-real-extraction.php</code></p>';
