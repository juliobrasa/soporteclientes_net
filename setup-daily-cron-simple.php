 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/setup-daily-cron-simple.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/setup-daily-cron-simple.php</code></p>';
