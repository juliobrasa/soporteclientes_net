 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/backup-database-secure.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/backup-database-secure.php</code></p>';
