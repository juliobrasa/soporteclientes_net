 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/verify-apify-setup.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/verify-apify-setup.php</code></p>';
