 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-booking-direct.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-booking-direct.php</code></p>';
