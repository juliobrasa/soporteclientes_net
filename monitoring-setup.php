 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/monitoring-setup.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/monitoring-setup.php</code></p>';
