 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/admin-debug-logs.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/admin-debug-logs.php</code></p>';
