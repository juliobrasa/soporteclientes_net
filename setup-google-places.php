 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/setup-google-places.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/setup-google-places.php</code></p>';
