 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-compass-google-maps.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-compass-google-maps.php</code></p>';
