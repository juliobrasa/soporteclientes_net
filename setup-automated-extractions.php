 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/setup-automated-extractions.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/setup-automated-extractions.php</code></p>';
