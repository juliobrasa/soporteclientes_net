 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/setup-review-tables.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/setup-review-tables.php</code></p>';
