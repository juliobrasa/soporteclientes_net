 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-different-hotel.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-different-hotel.php</code></p>';
