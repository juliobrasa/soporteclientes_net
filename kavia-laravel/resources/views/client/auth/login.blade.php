...
<body class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="max-w-md w-full space-y-8">
            ...
            <!-- Formulario de Login -->
            <form class="mt-8 space-y-6" method="POST" action="{{ route('client.login') }}">
                @csrf
    ...
    <!-- Notificaciones -->
    @if(session('success'))
        <div class="fixed top-4 right-4 bg-green-500 text-white p-4 rounded-lg shadow-lg max-w-sm">
            <div class="flex items-center">
