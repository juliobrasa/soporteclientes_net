 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-laravel11.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-laravel11.php</code></p>';
