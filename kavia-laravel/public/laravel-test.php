 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/laravel-test.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/laravel-test.php</code></p>';
