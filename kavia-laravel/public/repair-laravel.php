 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/repair-laravel.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/repair-laravel.php</code></p>';
