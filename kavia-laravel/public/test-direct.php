 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-direct.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-direct.php</code></p>';
