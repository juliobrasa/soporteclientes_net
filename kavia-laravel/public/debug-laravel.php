 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/debug-laravel.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/debug-laravel.php</code></p>';
