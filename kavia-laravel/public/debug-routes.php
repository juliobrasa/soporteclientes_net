 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/debug-routes.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/debug-routes.php</code></p>';
