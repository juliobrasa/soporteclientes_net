 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/final-test.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/final-test.php</code></p>';
