 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/ultra-test.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/ultra-test.php</code></p>';
