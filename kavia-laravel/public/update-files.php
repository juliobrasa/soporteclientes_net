 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/update-files.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/update-files.php</code></p>';
