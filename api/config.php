<?php
// api/config.php - VERSIÓN SEGURA CORREGIDA
...
// Verificar autenticación para acceso a APIs
session_start();
if (!isset($_SESSION['admin_logged']) || $_SESSION['admin_logged'] !== true) {
    http_response_code(401);
    echo json_encode(['error' => 'No autorizado', 'message' => 'Sesión de administrador requerida']);
    exit;
}

// Configuración segura de la base de datos desde .env
define('DB_HOST', EnvironmentLoader::get('DB_HOST', 'localhost'));
define('DB_NAME', EnvironmentLoader::get('DB_DATABASE', 'soporteclientes_db'));
define('DB_USER', EnvironmentLoader::get('DB_USERNAME', ''));
define('DB_PASS', EnvironmentLoader::get('DB_PASSWORD', ''));
...
// Función para validar parámetros con sanitización
