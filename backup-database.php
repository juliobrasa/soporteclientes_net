 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/backup-database.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/backup-database.php</code></p>';
