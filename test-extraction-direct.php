 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-extraction-direct.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-extraction-direct.php</code></p>';
