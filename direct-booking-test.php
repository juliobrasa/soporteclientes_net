 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/direct-booking-test.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/direct-booking-test.php</code></p>';
