 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/run-booking-test.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/run-booking-test.php</code></p>';
