 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-db.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-db.php</code></p>';
