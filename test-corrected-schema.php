 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-corrected-schema.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-corrected-schema.php</code></p>';
