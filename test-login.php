 ...
 * Script original movido a: /root/soporteclientes_net/admin-tools/test-login.php
...
echo '<p>Ubicación segura: <code>/root/soporteclientes_net/admin-tools/test-login.php</code></p>';
